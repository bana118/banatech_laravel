...
<script>
    ...
    onload = function () {
        ...
        async function preloadModel() {
            const model = await tf.loadLayersModel("{{ asset('/other/reiwa/model/model.json') }}");
    ...
    function music_init() {
        ...
        var manifest = [{
                src: "{{ asset('/music/reiwa/gamestart.mp3') }}"
            },
            {
                src: "{{ asset('/music/reiwa/ariori.mp3') }}"
            },
            {
                src: "{{ asset('/music/reiwa/correct.mp3') }}"
            },
            {
                src: "{{ asset('/music/reiwa/wrong.mp3') }}"
            }
        ];
