...
/***/ "./resources/js/hakogucha/hakogucha.js":
/*!*********************************************!*\
  !*** ./resources/js/hakogucha/hakogucha.js ***!
  \*********************************************/
/*! no exports provided */
...
var size = 40; //ブロックのサイズ

var backgroundSize = size * 10;
var pushSoundEffect;
var moveSoundEffect;
...
onload = function onload() {
  ...
  player = new Player();
  reset();
  pushSoundEffect = new howler__WEBPACK_IMPORTED_MODULE_1__["Howl"]({
    src: [location.origin + "/music/hakogucha/push.mp3"]
  });
  moveSoundEffect = new howler__WEBPACK_IMPORTED_MODULE_1__["Howl"]({
    src: [location.origin + "/music/hakogucha/move.mp3"]
  });
  deleteSoundEffect = new howler__WEBPACK_IMPORTED_MODULE_1__["Howl"]({
    src: [location.origin + "/music/hakogucha/delete.mp3"]
  });
  punchSoundEffect = new howler__WEBPACK_IMPORTED_MODULE_1__["Howl"]({
    src: [location.origin + "/music/hakogucha/punch.mp3"]
  });
  startSoundEffect = new howler__WEBPACK_IMPORTED_MODULE_1__["Howl"]({
    src: [location.origin + "/music/hakogucha/gamestart.mp3"]
  });
  overSoundEffect = new howler__WEBPACK_IMPORTED_MODULE_1__["Howl"]({
...
function reset() {
  ...
  board.reset();
  player.reset();
  animejs__WEBPACK_IMPORTED_MODULE_0__["default"].set(player.player, {
    translateY: 0,
    scaleY: 1
  });
  ladderSet();
...
function scoreUp(num) {
  ...
  score += 100 * num * Math.pow(2, combo);
  combo++;
...
window.setVolume = function (value) {
  ...
  howler__WEBPACK_IMPORTED_MODULE_1__["Howler"].volume(volume);
...
function () {
  function Board() {
    ...
    /* 縦横逆なことに注意 */
    this.array = [[0, 0, 0, 0, 0, 0, 0, 10, 40], [0, 0, 0, 0, 0, 0, 0, 20, 30], [0, 0, 0, 0, 0, 0, 0, 40, 10], [0, 0, 0, 0, 0, 0, 0, 30, 20], [0, 0, 0, 0, 0, 0, 0, 10, 40], [0, 0, 0, 0, 0, 0, 0, 20, 30], [0, 0, 0, 0, 0, 0, 0, 40, 10], [0, 0, 0, 0, 0, 0, 0, 30, 20], [0, 0, 0, 0, 0, 0, 0, 10, 40], [0, 0, 0, 0, 0, 0, 0, 20, 30]];
  ...
  _createClass(Board, [{
    ...
    key: "random_generate",
    value: function random_generate(exceptI) {
    ...
    key: "generate",
    value: function generate(color, i) {
      if (mode != 3 && mode != -1) {
        ...
        Object(animejs__WEBPACK_IMPORTED_MODULE_0__["default"])({
          ...
          complete: function complete(anim) {
            animejs__WEBPACK_IMPORTED_MODULE_0__["default"].set(this.animatables[0].target, {
              translateX: 0
            });
            board.air([[i, 0]]);
            setTimeout(function () {
    ...
    value: function air(airList) {
      ...
      try {
        for (var _iterator = airList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      try {
        for (var _iterator2 = airList[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            ...
            Object(animejs__WEBPACK_IMPORTED_MODULE_0__["default"])({
              ...
              complete: function complete(anim) {
                ...
                if (flg == 0 && blockP.toString() == airList[0].toString() && mode != -1) {
                  ...
                  try {
                    for (var _iterator3 = airList[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                      var x = _step3.value;
                ...
                if (flg == 0 && blockP.toString() == airList[airList.length - 1].toString() && mode != -1) {
                  flg = 1;
                  var newAirList = [];
                  ...
                  try {
                    for (var _iterator4 = airList[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                      var x = _step4.value;
                      newAirList.push([x[0], x[1] + 1]);
                    }
                  } catch (err) {
    ...
    key: "collect",
    value: function collect(i, j, previousI, previousJ, color, deleteList) {
      if (i < 9 && Math.floor(this.array[i + 1][j] / 10) == color && i + 1 != previousI && deleteList.length < 70) {
        //苦肉の策
    ...
    key: "delete",
    value: function _delete(deleteList, airFlg) {
      ...
      try {
        for (var _iterator5 = deleteList[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
      ...
      try {
        for (var _iterator6 = deleteList[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
      ...
      if (airFlg == 0) {
        ...
        var airDeleteList = board.collectAir().filter(function (element) {
          ...
          try {
            for (var _iterator7 = allAirList[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
              var e = _step7.value;
      ...
      try {
        for (var _iterator8 = deleteList[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
  ...
  _createClass(Player, [{
    ...
    value: function punch() {
      if (this.x < 9 && this.state == 0 && board.array[this.x + 1][this.y] % 10 != 0) {
        ...
        if (Math.floor(board.array[this.x + 1][this.y] / 10) == 4 && board.array[this.x + 1][this.y] != 43) {
        ...
        if (Math.floor(board.array[this.x][this.y + 1] / 10) == 4 && board.array[this.x][this.y + 1] != 43) {
...
/***/ 3:
/*!***************************************************!*\
  !*** multi ./resources/js/hakogucha/hakogucha.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /mnt/c/Users/fluff/Documents/github_bana118/banatech_laravel/resources/js/hakogucha/hakogucha.js */"./resources/js/hakogucha/hakogucha.js");
